  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">      
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#home">Adonde Hay</a>
        </div>
	...
	<form role="form" method="post" action="index.php">
	    <div class="container">
	      ...
	      <div class="row">
	        ...
	        <div class="col-md-3">
	          <p class="lead">&iquest;Adonde Hay?</p>
	          <div class="list-group">
	          <div class="form-group">
			    <label for="busqueda">Producto, Servicio, Compa&ntilde;a</label>
	          ...
	          <div class="form-group">
	            ...
	            <br/>
	            <br/>
	            <a href="registrarme.php">Registrarme Gratis</a>
	          </div>
	        </div>
    ...
    <div class="container">
      ...
      <footer>
        <div class="row">
          <div class="col-lg-12">
            <p>Copyright &copy; Company 2013 - Template by <a href="http://maxoffsky.com/">Maks</a></p>
          </div>
        </div>
      </footer>
